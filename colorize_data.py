...
class ColorizeData(Subset):
    def __init__(self, root_dir="C:/Users/usham/anaconda3/envs/env_pytorch/Image_colourization/landscape_images", subset=Subset, input_transform=torchvision.transforms,
