...
class Trainer:
    ...
    def init_model_and_data(self, data_dir, use_gpu):
        # Initialize dataset - ColorizeData()
        data_dir = "C:/Users/usham/anaconda3/envs/env_pytorch/Image_colourization/landscape_images"
        ...
        if use_gpu:
            ...
            print(model)
            print("Model loaded on the GPU -> ", torch.cuda.get_device_name(1))
        else:
            print(model)
